            ...
            <div className='container'>
                <div className='services py-16 flex items-center justify-between'>
                    <div className='max-w-xs'>
                        ...
                        <p className='text-gray-500'>Eget malesuada tortor ut sed. Tincidunt viverra malesuada nisl vehicula vestibulum. Ut blandit fermentum, cursus nulla. Imperdiet neque mi convallis quis interdum sagittis.</p>
                    </div>
                    <div>
                        <div className='services_item'>
                            <Link to='/' className='flex items-center justify-between'>
                                <div className='flex items-center'>
                                    <img className='w-14 mr-8' src={img1} alt="" />
                                    <div className='mr-8'>
                        ...
                        <div className='services_item'>
                            <Link to='/' className='flex items-center justify-between'>
                                <div className='flex items-center'>
                                    <img className='w-14 mr-8' src={img2} alt="" />
                                    <div className='mr-8'>
                        ...
                        <div className='services_item'>
                            <Link to='/' className='flex items-center justify-between'>
                                <div className='flex items-center'>
                                    <img className='w-14 mr-8' src={img3} alt="" />
                                    <div className='mr-8'>
